...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FUN] = LAYOUT_reviung41(
    ...
    _______,  ___N___,  ___N___,  ___N___,  ___N___,  KC_DEL,             KC_END,   ___N___,  KC_MPLY,  ___N___,  KC_LALT,  KC_RCTL,
                                            KC_WBAK,  VS_BACK, TT(_FUN),  VS_FWD,  KC_WFWD
  ),

  [_NUM] = LAYOUT_reviung41(
    KC_0,     KC_1,     KC_2,     KC_3,     KC_4,     KC_5,               KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     SW_AA,
    K_TILD,   K_EXLM,   K_AT,     K_HASH,   K_DLR,    K_PERC,             ___N___,  KC_4,     KC_5,     KC_6,     SW_OE,    SW_AE,
    _______,  C(KC_Z),  C(KC_X),  C(KC_C),  C(KC_V),  ___N___,            KC_0,     KC_1,     KC_2,     KC_3,     ___N___,  _______,
                                            ___N___,  __XXX__,  ___N___,  KC_0,     KC_DOT
  ),

  [_NAV] = LAYOUT_reviung41(
    ALT_TAB,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,               KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     _______,
    _______,  K_EXLM,   K_AT,     K_HASH,   K_DLR,    K_PERC,             K_TILD,   K_CIRC,   KC_PGUP,  KC_HOME,  KC_UP,    KC_END,
  ...
  [_SYM] = LAYOUT_reviung41(
    _______,  K_EQUAL,  ___N___,  ___N___,  K_PIPE,   K_LBRC,             K_RBRC,   K_AMPR,   KC_P7,    KC_P8,    KC_P9,    _______,
    _______,  K_PLUS,   ___N___,  ___N___,  K_LPRN,   K_LCBR,             K_RCBR,   K_RPRN,   KC_P4,    KC_P5,    KC_P6,    KC_PDOT,
    _______,  K_MINS,   ___N___,  ___N___,  K_SLSH,   K_LT,               K_GT,     K_BSLS,   KC_P1,    KC_P2,    KC_P3,    KC_P0,
                                            ___N___,  KC_SPC,   ___N___,  __XXX__,  K_DOT
  ),

  [_EXT] = LAYOUT_reviung41(
    _______,  ___N___,  G(KC_2),  G(KC_E),  ___N___,  C(KC_T),            ___N___,  ___N___,  ___N___,  G(KC_L),  ___N___,  _______,
